...
export class JuntaReceptoraVotosController {
  ...
  private _clientProxyJuntaReceptoraVotos =
    ...
    @Post()
    create(@Body() juntaReceptoraVotosDTO: JuntaReceptoraVotosDTO): Observable<IJuntaReceptoraVotos> {
          return this._clientProxyJuntaReceptoraVotos.send(JuntaReceptoraVotosMSG.CREATE, juntaReceptoraVotosDTO);
    }
  ...
  async update(
    ...
    return this._clientProxyJuntaReceptoraVotos.send(JuntaReceptoraVotosMSG.UPDATE, {
      id: parseInt(id),
